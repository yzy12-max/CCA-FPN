...
class FPN_CARAFE(BaseModule):
    ...
    def __init__(self,
        ...
        self.upsample_cfg = upsample_cfg.copy()  #神拷贝
        ...
        for i in range(self.start_level, self.backbone_end_level):
            ...
            fpn_conv = ConvModule(
                ...
                inplace=False,
                order=self.order)
            if i != self.backbone_end_level - 1:  #0，3 顶层不做上采样
                ...
                if self.upsample == 'deconv':
                ...
                elif self.upsample == 'pixel_shuffle':  #亚像素卷集上采样
                    upsample_cfg_.update(
                        in_channels=out_channels,
                        out_channels=out_channels,
                        scale_factor=2,
                    ...
                    upsample_cfg_.update(channels=out_channels, scale_factor=2)  #上采样2倍
                else:
                    # suppress warnings
                    align_corners = (None
    ...
    def forward(self, inputs):
        ...
        # build top-down path
        for i in range(len(laterals) - 1, 0, -1):  #4，3，2，1
