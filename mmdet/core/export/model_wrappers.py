...
class ONNXRuntimeDetector(DeployBaseDetector):
    ...
    def __init__(self, onnx_file, class_names, device_id):
        ...
        sess = ort.InferenceSession(onnx_file, session_options)  #下面的是为了使用GPU修改的
        # sess = ort.InferenceSession(onnx_file, session_options,providers=['TensorrtExecutionProvider', 'CUDAExecutionProvider', 'CPUExecutionProvider'])
