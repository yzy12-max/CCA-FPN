...
def parse_xml(args):
    ...
    img_abpath = osp.join('/data/datasets/VOCdevkit/'+img_path)
    img = cv2.imread(img_abpath)
    h ,w,_=img.shape
...
def parse_args():
    ...
    parser.add_argument('--devkit_path',default='/data/datasets/VOCdevkit/', help='pascal voc devkit path')
    #parser.add_argument('-o', '--out-dir',default='/data/datasets/VOCdevkit/A', help='output path')
    parser.add_argument('--out-dir', default='/data/datasets/VOCdevkit/VOC2007/', help='output path')
...
def main():
    ...
    for year in years:
        ...
        if not isinstance(year, list): #list
