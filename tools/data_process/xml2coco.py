...
def main():
    ...
    xml_path = '/data1/yzycode/datasets/VOCdevkit/test-B-box'
    img_path = '/data1/yzycode/datasets/VOCdevkit/test-B-image'
    print('processing {} ...'.format("xml format annotations"))
    # os.makedirs('/data/wjh/datasets/forUser_A/train/annotations/', exist_ok=True)
    cvt_annotations(img_path, xml_path, '/data1/yzycode/datasets/VOCdevkit/test_B.json')
    print('Done!')
