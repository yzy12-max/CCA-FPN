...
def main():
    ...
    img_path = '/data/datasets/VOCdevkit/VOC2007/JPEGImages'
    print('processing {} ...'.format("xml format annotations"))
    cvt_annotations(img_path, xml_path, '/data/datasets/VOCdevkit/VOC2007/Annotations/train.json')
    print('Done!')
